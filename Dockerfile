...
ARG ATB_NEXT_PUBLIC_CONTACT_API_URL
ARG ATB_NEXT_PUBLIC_BFF_URL
ARG ATB_NEXT_PUBLIC_WS_API_BASE_URL
...
ARG NFK_NEXT_PUBLIC_CONTACT_API_URL
ARG NFK_NEXT_PUBLIC_BFF_URL
ARG NFK_NEXT_PUBLIC_WS_API_BASE_URL
...
ARG FRAM_NEXT_PUBLIC_BFF_URL
ARG FRAM_NEXT_PUBLIC_WS_API_BASE_URL
...
ARG TROMS_NEXT_PUBLIC_CONTACT_API_URL
ARG TROMS_NEXT_PUBLIC_BFF_URL
ARG TROMS_NEXT_PUBLIC_WS_API_BASE_URL
...
ARG VKT_NEXT_PUBLIC_CONTACT_API_URL
ARG VKT_NEXT_PUBLIC_BFF_URL
ARG VKT_NEXT_PUBLIC_WS_API_BASE_URL
...
ARG FARTE_NEXT_PUBLIC_CONTACT_API_URL
ARG FARTE_NEXT_PUBLIC_BFF_URL
ARG FARTE_NEXT_PUBLIC_WS_API_BASE_URL
...
ENV NEXT_PUBLIC_CONTACT_API_URL=$ATB_NEXT_PUBLIC_CONTACT_API_URL
ENV NEXT_PUBLIC_BFF_URL=$ATB_NEXT_PUBLIC_BFF_URL
ENV NEXT_PUBLIC_WS_API_BASE_URL=$ATB_NEXT_PUBLIC_WS_API_BASE_URL
...
RUN --mount=type=secret,id=ATB_NEXT_PUBLIC_MAPBOX_API_TOKEN \
  ...
  --mount=type=secret,id=ATB_NEXT_PUBLIC_MAPBOX_USER_NAME \
  --mount=type=secret,id=ATB_NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID \
  --mount=type=secret,id=ATB_NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID \
  ...
  NEXT_PUBLIC_MAPBOX_USER_NAME=$(cat /run/secrets/ATB_NEXT_PUBLIC_MAPBOX_USER_NAME) \
  NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID=$(cat /run/secrets/ATB_NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID) \
  NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID=$(cat /run/secrets/ATB_NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID) \
  pnpm build:docker'
...
ENV NEXT_PUBLIC_CONTACT_API_URL=$NFK_NEXT_PUBLIC_CONTACT_API_URL
ENV NEXT_PUBLIC_BFF_URL=$NFK_NEXT_PUBLIC_BFF_URL
ENV NEXT_PUBLIC_WS_API_BASE_URL=$NFK_NEXT_PUBLIC_WS_API_BASE_URL
...
RUN --mount=type=secret,id=NFK_NEXT_PUBLIC_MAPBOX_API_TOKEN \
  ...
  --mount=type=secret,id=NFK_NEXT_PUBLIC_MAPBOX_USER_NAME \
  --mount=type=secret,id=NFK_NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID \
  --mount=type=secret,id=NFK_NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID \
  ...
  NEXT_PUBLIC_MAPBOX_USER_NAME=$(cat /run/secrets/NFK_NEXT_PUBLIC_MAPBOX_USER_NAME) \
  NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID=$(cat /run/secrets/NFK_NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID) \
  NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID=$(cat /run/secrets/NFK_NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID) \
  pnpm build:docker'
...
ENV NEXT_PUBLIC_BFF_URL=$FRAM_NEXT_PUBLIC_BFF_URL
ENV NEXT_PUBLIC_WS_API_BASE_URL=$FRAM_NEXT_PUBLIC_WS_API_BASE_URL
...
RUN --mount=type=secret,id=FRAM_NEXT_PUBLIC_MAPBOX_API_TOKEN \
  ...
  --mount=type=secret,id=FRAM_NEXT_PUBLIC_MAPBOX_USER_NAME \
  --mount=type=secret,id=FRAM_NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID \
  --mount=type=secret,id=FRAM_NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID \
  ...
  NEXT_PUBLIC_MAPBOX_USER_NAME=$(cat /run/secrets/FRAM_NEXT_PUBLIC_MAPBOX_USER_NAME) \
  NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID=$(cat /run/secrets/FRAM_NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID) \
  NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID=$(cat /run/secrets/FRAM_NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID) \
  pnpm build:docker'
...
ENV NEXT_PUBLIC_CONTACT_API_URL=$TROMS_NEXT_PUBLIC_CONTACT_API_URL
ENV NEXT_PUBLIC_BFF_URL=$TROMS_NEXT_PUBLIC_BFF_URL
ENV NEXT_PUBLIC_WS_API_BASE_URL=$TROMS_NEXT_PUBLIC_WS_API_BASE_URL
...
RUN --mount=type=secret,id=TROMS_NEXT_PUBLIC_MAPBOX_API_TOKEN \
  ...
  --mount=type=secret,id=TROMS_NEXT_PUBLIC_MAPBOX_USER_NAME \
  --mount=type=secret,id=TROMS_NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID \
  --mount=type=secret,id=TROMS_NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID \
  ...
  NEXT_PUBLIC_MAPBOX_USER_NAME=$(cat /run/secrets/TROMS_NEXT_PUBLIC_MAPBOX_USER_NAME) \
  NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID=$(cat /run/secrets/TROMS_NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID) \
  NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID=$(cat /run/secrets/TROMS_NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID) \
  pnpm build:docker'
...
ENV NEXT_PUBLIC_CONTACT_API_URL=$VKT_NEXT_PUBLIC_CONTACT_API_URL
ENV NEXT_PUBLIC_BFF_URL=$VKT_NEXT_PUBLIC_BFF_URL
ENV NEXT_PUBLIC_WS_API_BASE_URL=$VKT_NEXT_PUBLIC_WS_API_BASE_URL
...
RUN --mount=type=secret,id=VKT_NEXT_PUBLIC_MAPBOX_API_TOKEN \
  ...
  --mount=type=secret,id=VKT_NEXT_PUBLIC_MAPBOX_USER_NAME \
  --mount=type=secret,id=VKT_NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID \
  --mount=type=secret,id=VKT_NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID \
  ...
  NEXT_PUBLIC_MAPBOX_USER_NAME=$(cat /run/secrets/VKT_NEXT_PUBLIC_MAPBOX_USER_NAME) \
  NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID=$(cat /run/secrets/VKT_NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID) \
  NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID=$(cat /run/secrets/VKT_NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID) \
  pnpm build:docker'
...
ENV NEXT_PUBLIC_CONTACT_API_URL=$FARTE_NEXT_PUBLIC_CONTACT_API_URL
ENV NEXT_PUBLIC_BFF_URL=$FARTE_NEXT_PUBLIC_BFF_URL
ENV NEXT_PUBLIC_WS_API_BASE_URL=$FARTE_NEXT_PUBLIC_WS_API_BASE_URL
...
RUN --mount=type=secret,id=FARTE_NEXT_PUBLIC_MAPBOX_API_TOKEN \
  ...
  --mount=type=secret,id=FARTE_NEXT_PUBLIC_MAPBOX_USER_NAME \
  --mount=type=secret,id=FARTE_NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID \
  --mount=type=secret,id=FARTE_NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID \
  ...
  NEXT_PUBLIC_MAPBOX_USER_NAME=$(cat /run/secrets/FARTE_NEXT_PUBLIC_MAPBOX_USER_NAME) \
  NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID=$(cat /run/secrets/FARTE_NEXT_PUBLIC_MAPBOX_NSR_TILESET_ID) \
  NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID=$(cat /run/secrets/FARTE_NEXT_PUBLIC_MAPBOX_NSR_SOURCE_LAYER_ID) \
  pnpm build:docker'
