...
ARG ATB_NEXT_PUBLIC_ENVIRONMENT
...
ARG NFK_NEXT_PUBLIC_ENVIRONMENT
...
ARG FRAM_NEXT_PUBLIC_IN_STAGING
...
ARG TROMS_NEXT_PUBLIC_ENVIRONMENT
...
ENV NEXT_PUBLIC_ENVIRONMENT=$ATB_NEXT_PUBLIC_ENVIRONMENT
...
ENV NEXT_PUBLIC_ENVIRONMENT=$NFK_NEXT_PUBLIC_ENVIRONMENT
...
ENV NEXT_PUBLIC_ENVIRONMENT=$FRAM_NEXT_PUBLIC_ENVIRONMENT
...
ENV NEXT_PUBLIC_ENVIRONMENT=$TROMS_NEXT_PUBLIC_ENVIRONMENT
