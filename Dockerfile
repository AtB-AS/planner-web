...
ARG ATB_NEXT_PUBLIC_MAPBOX_API_TOKEN
ARG ATB_NEXT_PUBLIC_MAPBOX_STOP_PLACES_STYLE_URL
ARG ATB_NEXT_PUBLIC_MAPBOX_DEFAULT_LAT
ARG ATB_NEXT_PUBLIC_MAPBOX_DEFAULT_LNG

ARG NFK_NEXT_PUBLIC_MAPBOX_API_TOKEN
ARG NFK_NEXT_PUBLIC_MAPBOX_STOP_PLACES_STYLE_URL
ARG NFK_NEXT_PUBLIC_MAPBOX_DEFAULT_LAT
ARG NFK_NEXT_PUBLIC_MAPBOX_DEFAULT_LNG

ARG FRAM_NEXT_PUBLIC_MAPBOX_API_TOKEN
ARG FRAM_NEXT_PUBLIC_MAPBOX_STOP_PLACES_STYLE_URL
ARG FRAM_NEXT_PUBLIC_MAPBOX_DEFAULT_LAT
ARG FRAM_NEXT_PUBLIC_MAPBOX_DEFAULT_LNG

# Build AtB
ENV NEXT_PUBLIC_PLANNER_ORG_ID="atb"
ENV NEXT_PUBLIC_MAPBOX_API_TOKEN=$ATB_NEXT_PUBLIC_MAPBOX_API_TOKEN
ENV NEXT_PUBLIC_MAPBOX_STOP_PLACES_STYLE_URL=$ATB_NEXT_PUBLIC_MAPBOX_STOP_PLACES_STYLE_URL
...
ENV NEXT_PUBLIC_MAPBOX_API_TOKEN=$NFK_NEXT_PUBLIC_MAPBOX_API_TOKEN
ENV NEXT_PUBLIC_MAPBOX_STOP_PLACES_STYLE_URL=$NFK_NEXT_PUBLIC_MAPBOX_STOP_PLACES_STYLE_URL
...
ENV NEXT_PUBLIC_MAPBOX_API_TOKEN=$FRAM_NEXT_PUBLIC_MAPBOX_API_TOKEN
ENV NEXT_PUBLIC_MAPBOX_STOP_PLACES_STYLE_URL=$FRAM_NEXT_PUBLIC_MAPBOX_STOP_PLACES_STYLE_URL
