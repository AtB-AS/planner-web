...
ENV NEXT_PUBLIC_BFF_URL=$ATB_NEXT_PUBLIC_CONTACT_API_URL
...
ENV NEXT_PUBLIC_BFF_URL=$NFK_NEXT_PUBLIC_CONTACT_API_URL
...
ENV NEXT_PUBLIC_BFF_URL=$FRAM_NEXT_PUBLIC_CONTACT_API_URL
...
ENV NEXT_PUBLIC_BFF_URL=$TROMS_NEXT_PUBLIC_CONTACT_API_URL
...
ENV NEXT_PUBLIC_BFF_URL=$VKT_NEXT_PUBLIC_CONTACT_API_URL
...
ENV NEXT_PUBLIC_BFF_URL=$FARTE_NEXT_PUBLIC_CONTACT_API_URL
