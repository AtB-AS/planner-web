...
ARG ATB_NEXT_PUBLIC_IN_STAGING
...
ARG NFK_NEXT_PUBLIC_IN_STAGING
...
ARG TROMS_NEXT_PUBLIC_IN_STAGING
...
ENV NEXT_PUBLIC_IN_STAGING=$ATB_NEXT_PUBLIC_IN_STAGING
...
ENV NEXT_PUBLIC_IN_STAGING=$FRAM_NEXT_PUBLIC_IN_STAGING
...
ENV NEXT_PUBLIC_IN_STAGING=$TROMS_NEXT_PUBLIC_IN_STAGING
