...
ARG ATB_WAIT_RELUCTANCE
ARG ATB_WALKING_RELUCTANCE
ARG ATB_WALKING_SPEED
ARG ATB_TRANSFER_PENALTY
ARG ATB_TRANSFER_SLACK
...
ARG NFK_WAIT_RELUCTANCE
ARG NFK_WALKING_RELUCTANCE
ARG NFK_WALKING_SPEED
ARG NFK_TRANSFER_PENALTY
ARG NFK_TRANSFER_SLACK
...
ARG FRAM_WAIT_RELUCTANCE
ARG FRAM_WALKING_RELUCTANCE
ARG FRAM_WALKING_SPEED
ARG FRAM_TRANSFER_PENALTY
ARG FRAM_TRANSFER_SLACK
...
ENV WAIT_RELUCTANCE=$ATB_WAIT_RELUCTANCE
ENV WALKING_RELUCTANCE=$ATB_WALKING_RELUCTANCE
ENV WALKING_SPEED=$ATB_WALKING_SPEED
ENV TRANSFER_PENALTY=$ATB_TRANSFER_PENALTY
ENV TRANSFER_SLACK=$ATB_TRANSFER_SLACK
...
ENV WAIT_RELUCTANCE=$NFK_WAIT_RELUCTANCE
ENV WALKING_RELUCTANCE=$NFK_WALKING_RELUCTANCE
ENV WALKING_SPEED=$NFK_WALKING_SPEED
ENV TRANSFER_PENALTY=$NFK_TRANSFER_PENALTY
ENV TRANSFER_SLACK=$NFK_TRANSFER_SLACK
...
ENV WAIT_RELUCTANCE=$FRAM_WAIT_RELUCTANCE
ENV WALKING_RELUCTANCE=$FRAM_WALKING_RELUCTANCE
ENV WALKING_SPEED=$FRAM_WALKING_SPEED
ENV TRANSFER_PENALTY=$FRAM_TRANSFER_PENALTY
ENV TRANSFER_SLACK=$FRAM_TRANSFER_SLACK
