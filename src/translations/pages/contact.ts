  ...
  ticketControl: {
    ...
    feeComplaint: {
      ...
      firstAgreement: {
        ...
        question: _(
          'Vi har full forståing for at det kan vere ei ubehageleg oppleving å få gebyr ved billettkontroll, og vi veit at dei alle fleste ønsker å reise med gyldig billett.',
        ...
        rules: [
          ...
          _(
            ...
            'We may charge a fine even if you are under 15 years old.',
            'Vi kan krevje gebyr sjølv om du er under 15 år.',
          ),
        ],
      ...
      secondAgreement: {
        ...
        info: _(
          'Har du krav på rabatt men har fått gebyr fordi du ikkje kunne framvise gyldig legitimasjon, kan du få redusert gebyret ditt til 200 kroner ved å sende oss dokumentasjon på at du har rett på rabatt.',
