...
import { QuayFragment } from '@atb/page-modules/assistant/server/journey-planner/journey-gql/trip.generated.ts';
...
export function getStartModeAndPlaceText(
  ...
  if (tripPattern.legs[0].mode === 'foot' && tripPattern.legs[1]) {
    ...
    tmpStartName = getQuayName(t, startLeg.fromPlace.quay);
