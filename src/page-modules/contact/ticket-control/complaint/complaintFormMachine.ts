...
import {
  formInputValidator,
  InputErrorMessages,
} from '../../formInputValidator'; // Must update after postpone-payment PR is merged.
...
export const formMachine = setup({
  ...
  guards: {
    validateInputs: ({ context }) => formInputValidator(context), // Must update after postpone-payment PR is merged.
  },
  actions: {
    toggleAgreement: assign(({ context, event }) => {
      if (event.type === 'TOOGLE_AGREEMENT') {
